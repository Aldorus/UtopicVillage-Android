...
public class ListAdapter extends ArrayAdapter<ElementListInterface> {
	//this class used as an adaptator for the element of type ElementListInterface
	//with this class who can build easily an Spinner view
	
	public ListAdapter(Context context, int textViewResourceId) {
	    super(context, textViewResourceId);
	}

	private List<ElementListInterface> entities;
	int ressource;
	MasterActivity activity;
	
	public ListAdapter(List<ElementListInterface> entities, MasterActivity activity) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
	    ...
	    ElementListInterface entity = entities.get(position);
